...
import os
import sys
sys.path.append('/home/priran/language_identification-word/src/')
...
from Vocab_char import prepare_dataset
import constant
...
# if cuda:
#     torch.cuda.set_device(0)  # Change the cuda number
# else:
#     torch.device("cpu")
pad_idx = 0
...
PATH = "saved_models/MODEL/model.pt1"
